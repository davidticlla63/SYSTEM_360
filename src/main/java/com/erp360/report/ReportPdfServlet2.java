...
@WebServlet("/ReportPdfServlet2")
public class ReportPdfServlet2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			try {
				if (request.getSession().getAttribute("parameter2") != null
						&& request.getSession().getAttribute("path2") != null) {

					Map<String, Object> parameters = (Map<String, Object>) request
							.getSession().getAttribute("parameter2");
				...
				request.getSession().removeAttribute("parameter2");
				request.getSession().removeAttribute("path2");
